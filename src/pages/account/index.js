  ...
  document
   ...
   .addEventListener("submit", function (e) {
    ...
    if (e.target[0]?.files[0]) {
     document.querySelector(".modal.change-avatar .error").style.display =
      "none";
    } else {
     document.querySelector(".modal.change-avatar .error").style.display =
      "block";
  ...
  document
   ...
   .addEventListener("change", function (e) {
    ...
    if (image.type?.split("/")[0] === "image") {
     ...
     document.querySelector(".modal.change-avatar .label").style.display =
      "none";

     document.querySelector(".modal.change-avatar .title").style.display =
      "block";
     document.querySelector(".modal.change-avatar .error-title").style.display =
      "none";
    } else {
