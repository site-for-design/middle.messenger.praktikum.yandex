...
export default (props = {}) => {
    ...
    const script = () => {
        ...
        })
        {
            ...
            addEventListenerAll(document.querySelectorAll('[data-click="changeAvatar"]'), 'click', () => {
                const modal = document.querySelector(`.modal.change-avatar`);
                modal.classList.toggle('active');
                overlay.classList.toggle('active');
            })
            addEventListenerAll(document.querySelectorAll('[data-click="addUser"]'), 'click', () => {
                const modal = document.querySelector(`.modal.add-user`);
                modal.classList.toggle('active');
                overlay.classList.toggle('active');
            })
            addEventListenerAll(document.querySelectorAll('[data-click="removeUser"]'), 'click', () => {
